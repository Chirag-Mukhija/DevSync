...
export default function SignInPage() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      <div className="w-full max-w-md p-8 bg-white/5 backdrop-blur rounded-xl shadow-2xl text-center border border-white/6">
        <div className="mb-4">
          <h1 className="text-3xl font-extrabold text-white">Welcome back</h1>
          <p className="text-sm text-slate-300 mt-2">Sign in to continue collaborating in real-time</p>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-3">
          <button
            ...
            className="inline-flex items-center justify-center gap-3 rounded-full bg-neutral-900/80 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-900/95 transition"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-3 rounded-full bg-white/6 px-4 py-2 text-sm font-medium text-white hover:bg-white/8 transition"
          >
        ...
        <div className="mt-4 text-xs text-slate-400">We never share your data. Secure workspaces · Live collaboration</div>
      </div>
    </main>
  );
}
